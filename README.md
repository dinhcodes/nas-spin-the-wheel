...
now so its stock hits zero right at 6pm on day 2. The `Try Again` wildcard takes the
...
`Try Again` fills the gap. During the event, auto mode re-tunes pacing from the live
